...
{choose-answers: 4}
? On the technical audience presentation slides (found [here](bit.ly/general_audience)), on slide 134, which of these is one of the terms on this outline slide?

C) "Useful for future study"
C) "Easy to Get" 
C) "Comprehensive"
o) "Simple to Download"
o) "Understandable"
o) "Detail-oriented"
o) "Fully-reproducible"
...
o) Talk about it, but don't put any information on your slide
o) Don't include it, but expect the audience to ask a question about it

{choose-answers: 4}
? Which of the following should you be sure to do when presenting to a general audience?

C) Include a conclusion slide letting the audience know what the take-home message is
C) Wrap up your presentation at the end by letting your audience know what they should take away from this presentation
o) Discuss the most important topic at the end, even if it fits better elsewhere in your story
o) Skip outline slides -- there's a lot to cover and you don't want to waste time on an outline
o) Jump right into the analysis, since you have a time limit
o) Take as much time as you need to explain the topics, no matter what time limit you've been given
o) Assume that everyone knows as much as you do and limit your explanations
o) Use big words and jargon to show how smart you are
